...
import static com.example.chatapp.MyDatabaseHelper.COLUMN_CUS_ID;
...
public class ScheduleDAO {
    ...
    //notification
    void scheduleNotification(long scheduleId, String scheduleTime) {
        ...
        intent.putExtra("scheduleId", scheduleId); // Use the scheduleId
